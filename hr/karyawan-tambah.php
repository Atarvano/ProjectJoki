...
$dashboard_context = [
    ...
    'page_title' => 'Tambah Karyawan - Sicuti HRD',
    'breadcrumb' => [
...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <h2 class="h3 mb-0 text-gray-800">Tambah Karyawan</h2>
...
<?php if ($summary_error !== ''): ?>
    <div class="alert alert-danger mb-4" role="alert">
        <strong>Data belum bisa disimpan.</strong><br>
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        <form method="post" action="/hr/karyawan-tambah.php" novalidate>
            <div class="row g-3">
                <div class="col-md-6">
