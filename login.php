    ...
    if ($username === '' || $password === '') {
        ...
        if ($stmt) {
            ...
            if ($user && password_verify($password, $user['password'])) {
                ...
                if ($user['role'] !== 'hr' && $user['karyawan_id'] !== null) {
                    ...
                    if ($stmt2) {
                        ...
                        if ($karyawan && isset($karyawan['nama']) && trim((string) $karyawan['nama']) !== '') {
                            $_SESSION['nama'] = trim((string) $karyawan['nama']);
                        }
                    }
                }
...
<div class="login-split">
        ...
        <div class="login-form-inner">
            <div class="login-brand-block">
                <div class="login-brand-logo d-flex align-items-center gap-2">
                    <img src="/assets/icons/ptx-logo.svg" class="company-logo" alt="Logo Perusahaan">
                    <span class="text-secondary fw-bold fs-5">PT X</span>
                </div>
                <div class="login-brand-divider"></div>
                <div class="login-brand-logo d-flex align-items-center gap-2">
                    <img src="/assets/icons/sicuti-logo.svg" class="sicuti-logo" alt="Logo Sicuti HRD">
                    <span class="text-secondary fw-bold fs-5">Sicuti HRD</span>
                </div>
            </div>
            ...
            <form method="POST" action="login.php?role=<?php echo htmlspecialchars($role); ?>"
                class="login-fields mb-3">
                <div class="mb-3 text-start">
                    <label class="form-label text-muted small">NIK</label>
                    <input type="text" name="username" class="form-control" placeholder="Masukkan NIK Anda"
    ...
    <div class="login-illustration-panel">
        ...
        <svg class="login-float float-3 decorative-float" style="top: 30%; right: 10%;" viewBox="0 0 100 100"
            aria-hidden="true">
        ...
        <?php if ($is_hr): ?>
            ...
            <svg class="login-illustration" viewBox="0 0 800 600" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
                ...
                <!-- Large Monitor -->
                <rect x="250" y="150" width="220" height="150" rx="8" fill="var(--color-surface)"
                ...
                <path d="M 280 260 L 320 200 L 370 230 L 410 180 L 440 210" fill="none" stroke="var(--color-accent)"
                ...
                <!-- Document / Report -->
                <rect x="520" y="240" width="100" height="140" rx="4" fill="var(--color-surface)"
                    stroke="var(--color-primary-light)" stroke-width="4" transform="rotate(15 520 240)" />
                <rect x="540" y="270" width="60" height="6" rx="3" fill="var(--color-primary-light)"
                    transform="rotate(15 520 240)" />
                <rect x="540" y="290" width="40" height="6" rx="3" fill="var(--color-primary-light)"
                    transform="rotate(15 520 240)" />
                <rect x="540" y="310" width="50" height="6" rx="3" fill="var(--color-primary-light)"
                    transform="rotate(15 520 240)" />

                <!-- Checkmark / Success Cue -->
                <circle cx="630" cy="220" r="20" fill="var(--color-success)" />
                <path d="M 620 220 L 626 226 L 640 212" fill="none" stroke="var(--color-surface)" stroke-width="4"
                ...
                <!-- Glasses -->
                <rect x="360" y="260" width="35" height="20" rx="4" fill="none" stroke="var(--color-primary-dark)"
                    stroke-width="4" />
                <rect x="405" y="260" width="35" height="20" rx="4" fill="none" stroke="var(--color-primary-dark)"
                    stroke-width="4" />
                <path d="M 395 270 L 405 270" stroke="var(--color-primary-dark)" stroke-width="4" />

                <!-- Arm pointing at screen -->
                <path d="M 460 400 Q 520 380 440 250" fill="none" stroke="var(--color-primary-dark)" stroke-width="24"
        ...
        <?php else: ?>
            ...
            <svg class="login-illustration" viewBox="0 0 800 600" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
                ...
                <!-- Large Calendar -->
                <rect x="450" y="120" width="200" height="220" rx="12" fill="var(--color-surface)"
                    stroke="var(--color-primary-light)" stroke-width="4" />
                ...
                <!-- Airplane / Trip Cue -->
                <path d="M 680 180 L 730 160 L 710 200 L 700 190 L 680 200 Z" fill="var(--color-primary)"
                    transform="rotate(15 680 180)" />

                <!-- Checklist Prop -->
                <rect x="180" y="220" width="120" height="160" rx="8" fill="var(--color-surface)"
                    stroke="var(--color-primary-subtle)" stroke-width="4" transform="rotate(-10 180 220)" />
                <circle cx="210" cy="260" r="8" fill="var(--color-success)" transform="rotate(-10 180 220)" />
                <rect x="235" y="256" width="50" height="8" rx="4" fill="var(--color-primary-subtle)"
                    transform="rotate(-10 180 220)" />
                <circle cx="210" cy="290" r="8" fill="var(--color-surface-alt)" stroke="var(--color-primary-subtle)"
                    stroke-width="2" transform="rotate(-10 180 220)" />
                <rect x="235" y="286" width="40" height="8" rx="4" fill="var(--color-primary-subtle)"
                    transform="rotate(-10 180 220)" />
                ...
                <!-- Arm celebrating -->
                <path d="M 480 430 Q 560 400 530 280" fill="none" stroke="var(--color-primary-dark)" stroke-width="24"
                    stroke-linecap="round" />

                <!-- Coffee cup -->
                <rect x="620" y="450" width="40" height="60" rx="4" fill="var(--color-surface)"
                    stroke="var(--color-primary-subtle)" stroke-width="2" />
